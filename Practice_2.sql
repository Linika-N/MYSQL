...
CREATE TABLE games(
    ...
    INDEX game_names_index(game_name)
);
...
INSERT INTO games (game_name, description, is_free)
VALUES ('шарики', 'Составь ряд из шариков по цветам', 1),
('2048','Набери как можно больше баллов', 0),
('Судоку', 'Реши головоломку', 1),
('UFC', 'Сможешь победить на ринге?', 0),
('Косынка', 'Карточная игра', 0),
('Ферма','Вырасти свой огород и животных',1),
('Гонки','Выбери для себя лучший автомобиль и вперед за победой',0),
('Монополия', 'Теперь играть можно онлайн',1),
('Нарды','Одолей соперника быстрее',1),
('Синий трактор','Теперь твой любимый герой в мобильной игре', 0);

INSERT INTO games_list (user_id, game_id)
VALUES (1,1),
(1,4),
(1, 8),
(2,2),
